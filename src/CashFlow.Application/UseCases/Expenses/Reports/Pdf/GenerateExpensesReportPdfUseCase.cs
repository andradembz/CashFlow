...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private Document CreateDocument(DateOnly month)
    {
        ...
        document.Info.Author = "Miguel Andrade";
    ...
    private void CreateHeaderWithProfilePhotoAndName(Section page)
    {
        ...
        var pathFile = Path.Combine(directoryName!, "UseCases\\Expenses\\Reports\\Pdf\\Img", "profileimg.png");

        row.Cells[0].AddImage(pathFile);

        row.Cells[1].AddParagraph("Hey, Miguel Andrade");
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{totalExpenses} {ResourceReportGenerationMessages.CURRENCY_SYMBOL}", new Font { Name = FontHelper.WORKSANS_Black, Size = 50 });
    }
    ...
    {
        cell.AddParagraph($"{amount} {ResourceReportGenerationMessages.CURRENCY_SYMBOL}");
        cell.Format.Font = new Font { Name = FontHelper.WORKSANS_REGULAR, Size = 12, Color = ColorsHelper.BLACK };
